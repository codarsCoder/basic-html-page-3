function sec(data) {
  ...
  document.getElementById("pizza").innerHTML = "Orta Boy " + pizza[0] + " Pizza";
...
function exstraCost() {
  ...
  document.getElementById("sum").value =(piece * 
   (Number(document.getElementById("pizza-cost").innerHTML) + p_sum));
